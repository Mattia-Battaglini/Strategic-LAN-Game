...
- **Movimento (BFS):** montagna inattraversabile salvo trait `mountain`; acqua inattraversabile salvo trait `swim`; nemici bloccano il percorso, amiche impilabili. Un'unità agisce una volta per round (`has_moved`), tranne le unità `strike` che possono anche attaccare dopo la mossa.
